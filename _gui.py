...
#
# Created: Thu Feb 18 11:01:36 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cos2d.setGeometry(QtCore.QRect(10, 460, 21, 19))
        self.cos2d.setText("")
        self.cos2d.setTristate(False)
        self.cos2d.setObjectName("cos2d")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(28, 482, 291, 21))
        ...
        self.label_59.setGeometry(QtCore.QRect(28, 500, 351, 21))
        self.label_59.setStatusTip("")
        self.label_59.setObjectName("label_59")
        self.label_28 = QtWidgets.QLabel(self.centralwidget)
        self.label_28.setGeometry(QtCore.QRect(28, 460, 391, 19))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setToolTip(_translate("MainWindow", "<html><head/><body><p>The matrix elements can take a while to compute.</p><p>Precomputed matrix elements might be available, though.</p></body></html>"))
        self.label_5.setText(_translate("MainWindow", "Note:   May be really slow."))
        ...
        self.label_59.setToolTip(_translate("MainWindow", "<html><head/><body><p>Unless the required matrix elements are available.</p></body></html>"))
        self.label_59.setText(_translate("MainWindow", "Note2: May require the U2d helper program"))
        self.label_28.setToolTip(_translate("MainWindow", "<html><head/><body><p>&lt;cos<span style=\" vertical-align:super;\">2</span>θ<span style=\" vertical-align:sub;\">2d</span>&gt; is typically the only available observable in an actual experiment.</p></body></html>"))
        self.label_28.setStatusTip(_translate("MainWindow", "For direct comparison with experiments"))
        self.label_28.setText(_translate("MainWindow", "<html><head/><body><p>Also calculate &lt;cos<span style=\" vertical-align:super;\">2</span> θ<span style=\" vertical-align:sub;\">2d</span>&gt; (linear molecules only).</p></body></html>"))
